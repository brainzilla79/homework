...
var fetchSearchGiphys = exports.fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return function (dispatch) {
    _api_util2.default.fetchSearchGiphys(searchTerm).then(function (giphys) {
...
var GiphysIndex = function (_React$Component) {
  ...
  _createClass(GiphysIndex, [{
    ...
    value: function render() {
      var giphyIndexItems = this.props.giphys.map(function (giphy, i) {
...
var GiphysIndexItem = function (_React$Component) {
  ...
  function GiphysIndexItem(props) {
    ...
    return _possibleConstructorReturn(this, (GiphysIndexItem.__proto__ || Object.getPrototypeOf(GiphysIndexItem)).call(this, props));
  }
  ...
  _createClass(GiphysIndexItem, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement('img', { src: this.props.giphy.images.original.url })
      );
    }
  }]);
  ...
  _createClass(GiphysSearch, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement('input', { type: 'text', id: 'searchText', value: this.state.searchTerm, onChange: this.handleChange }),
        _react2.default.createElement('input', { type: 'submit', value: 'Search', onClick: this.handleSubmit }),
...
var APIUtil = function () {
  ...
  _createClass(APIUtil, null, [{
    key: 'fetchSearchGiphys',
    value: function fetchSearchGiphys(searchTerm) {
      return $.ajax({
        method: 'GET',
